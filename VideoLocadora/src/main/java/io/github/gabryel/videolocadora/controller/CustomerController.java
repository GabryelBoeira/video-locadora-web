...
public class CustomerController implements CustomerApi {
    ...
    @Override
    public ResponseEntity<CustomerDetailDTO> getById(Long id) throws BusinessException {
    ...
    @Override
    public ResponseEntity<Void> updateCustomer(Long id, @Valid @RequestBody CustomerSaveDTO updateDto) throws BusinessException {
        customerService.update(id, updateDto);
        return ResponseEntity.ok().build();
    }

    @Override
    public ResponseEntity<CustomerDetailDTO> getCustomerByCpf(String cpf) throws BusinessException {
